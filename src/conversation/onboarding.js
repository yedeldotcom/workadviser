...
אני כאן לעזור לך להבין מה מקשה בעבודה — ומה אפשר לעשות.

אנחנו בפיילוט *מותאם טראומה*: פרויקט של נט"ל וירון אדל שמלווה אנשים עם טראומה להצליח בעבודה.

בסוף השיחה תקבל/י:
• רעיונות מותאמים אישית למצב שלך
• כלים לשיחה עם המעסיק — אם תרצה/י

המידע שמרי ומאובטח. ואפשר לעצור, לדלג או לקחת הפסקה בכל שלב.
