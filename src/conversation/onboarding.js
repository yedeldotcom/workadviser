...
אנחנו בפיילוט: *מותאם טראומה* — דרך חדשה לעזור לאנשים עם טראומה להישאר ולהצליח בעבודה. פרויקט של נט"ל וירון אדל.

בשיחה נעבור על מה שמקשה בעבודה. בסוף תקבל:
• רעיונות מותאמים אישית
• כלים לתקשורת עם המעסיק — אם רלוונטי

ההשתתפות שלך עוזרת לנו לפתח את הפרויקט. המידע שמרי ומאובטח.

*דלג*, *עצור*, *הפסקה* — אפשר בכל שלב.
